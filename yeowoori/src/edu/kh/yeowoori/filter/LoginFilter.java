package edu.kh.yeowoori.filter;
...
@WebFilter(filterName ="loginFilter", urlPatterns = {"/member/myPage"})
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if( session.getAttribute("loginMember") == null ) { //object로 넘어오지만 loginMember가 있는지 없는지만 확인할거라 형변환 안함
